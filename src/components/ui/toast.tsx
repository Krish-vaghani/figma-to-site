  ...
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-2xl border p-5 pr-10 shadow-2xl backdrop-blur-sm transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-top-full",
  {
    variants: {
      variant: {
        ...
        success: "border-[hsl(var(--toast-success))]/50 bg-[hsl(var(--toast-success))]/95 text-[hsl(var(--toast-success-foreground))]",
        info: "border-[hsl(var(--toast-info))]/50 bg-[hsl(var(--toast-info))]/95 text-[hsl(var(--toast-info-foreground))]",
        warning: "border-[hsl(var(--toast-warning))]/50 bg-[hsl(var(--toast-warning))]/95 text-[hsl(var(--toast-warning-foreground))]",
      },
    },
    defaultVariants: {
      variant: "default",
