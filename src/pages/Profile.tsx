...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Header area with background from top (Navbar + title + Quick Link card) */}
      <div
        className="relative w-full overflow-hidden bg-cover bg-top-left sm:bg-left-top"
      ...
      >
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-4 sm:px-6">
          ...
          {/* Quick Link card — on background, fully visible */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.4 }}
            className="rounded-3xl border border-border bg-card shadow-lg overflow-hidden mb-6 mt-6"
          >
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 pb-20 space-y-6">
        {/* Recent Orders */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
